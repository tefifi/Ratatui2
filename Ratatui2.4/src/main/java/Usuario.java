...
public class Usuario {
    ...
    public void agregarCondicion() {
        System.out.println("¿Qué condición quieres agregar? (Diabetes/Hipertension/Vegetariano/Vegano/Hipolactasia)");

        switch (scanner.next().toLowerCase()) {
            case "diabetes":
                condiciones.add(new Diabetes());
                System.out.println("Condición 'Diabetes' agregada.");
                break;

            case "hipertension":
                condiciones.add(new Hipertension());
                System.out.println("Condición 'Hipertensión' agregada.");
                break;
            ...
            case "hipolactasia":  // Alias alternativo
