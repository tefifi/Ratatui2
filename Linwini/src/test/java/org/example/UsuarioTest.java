...
public class UsuarioTest {
    ...
    void testAgregarReceta() {
        ...
        // Asignar algunos valores a la receta para que sea válida
        receta.atributosReceta(); // Esto cargaría datos reales, para pruebas unitarias se podría mockear o usar datos fijos
